...
@media (max-width: 767px) {
  ...
  .tablexxx-responsive > .tablexxx-bordered > tfoot > tr:last-child > td {
	...
	<body>
       ...
       <table width="355" border="1" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td width="117">Banco</td>
      <td width="170">Citibank</td>
      <td width="8">&nbsp;</td>
    </tr>
    <tr>
      <td>Nombre del titular</td>
      <td>Zapateria yobana</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Numero de cuenta</td>
      <td>0-1239839388838382919</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<div class="panel-body">
					...
					@else
					<p class="bg-success">Su pedido fue procesado correctamente, una ves realizado el deposito por favor contactenos a los siguientes telefonos o al correo jmvarguez@gmail.com para que su pedido se enviado a la brevedad posible. Gracias por su preferncia.</p>
					@endif
	</div>
	</body>
</html>