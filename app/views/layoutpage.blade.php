...
<div class="wrap">
    ...
    <div class="header_right">
        ...
        <li id="liCart" style="width: auto;"  class="cart">
							        	...
							        	<a href="{{route('confirmPay')}} "><i  style="font-size: 15px;" ></i><img src="{{ asset('assets/images/icon_4.png') }}" width="22" height="21" alt=""/>[<span id="items"> <?php if($tp < 1){ echo "vacio";}else{echo $items. " item(s) - $".$total;} ?></span>]
							        	</a>
