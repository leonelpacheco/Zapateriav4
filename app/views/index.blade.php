...
<div class="slider"> 
    ...
    <div class="wrapper">
        ...
        Pantuflas
         ...
         -->
        <ul class="ei-slider-thumbs" id="categorias">
...
<div class="main_bg">
    ...
    <div class="main">
     ...
     <?php /*?>   <?php $a=1; ?>
        ...
        @endif
        <div class="grid1_of_3"> <a href="{{route('index')}}/producto/{{$producto->id}}" class=""> <img class="img-responsive" style="max-width:130px; height:84px;" src="assets/img/productos/{{$producto->img}}" alt="{{$producto->producto}}">
          <h3>{{$producto->producto}}</h3>
          <span class="price"> ${{$producto->precio_inicial}}</span> </a><span class="price1 bg">En venta</span> </a> </div>
        ...
        <div class="clear"></div>
        @elseif ($producto->activo==3) <span class="text-right precio">Solo en Tienda</span> <a class="btn btn-primary btn-sm" href="{{route('index')}}/producto/{{$producto->id}}" >Ver Detalles</a> @endif
...
@section('js')
    ...
    {{HTML::script('assets/js/scriptJS/scriptCatalogoindex.js')}}
@stop
