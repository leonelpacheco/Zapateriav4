...
/*<div class="grid1_of_3"> <a href="details.html"> <img src="{{ asset('assets/images/pic1.jpg') }}" alt=""/>
		  ...
		  j=1; 	for (var x = inicio; x < fin; x++) {
		var activ=arrProductos[x].activo;
		
		if(j==1){
			
			htmlProductos += 	'<div class="grids_of_3">';
			
		}
			htmlProductos += 	'<div class="grid1_of_3">';
			htmlProductos +=			'<a href="'+$("#root").val()+"/producto/"+arrProductos[x].id+'" class="">';
			htmlProductos +=				'<img class="img-responsive" style="max-width:186px; height:210px;"src="assets/img/productos/'+arrProductos[x].img+'" alt="'+arrProductos[x].producto+'">';
			htmlProductos +=			'';	
		...
		if(activ==1){
				...
				htmlProductos +=			 	'<h3 class="nombre">'+arrProductos[x].producto+'</h3>';
			htmlProductos +=        		 ' <span class="price precio">$'+formatMoney(arrProductos[x].precio_inicial,2)+'</span><a class="btn btn-primary btn-sm addCart" href="'+arrProductos[x].id+'" name="'+arrProductos[x].producto+'" >Al carrito</a>';
			htmlProductos +=			 '</a>';																																																
			htmlProductos += 		'</div>';
		...
		if(j==3){
			htmlProductos += 		'</div>';
						htmlProductos += 	'<div class="clear"></div>';
